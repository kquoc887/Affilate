                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label for="company_name">Tên công ty (*) <span class="text-danger" id ="company_name_error"></span></label>
                            <input type="text" name="company_name" class="form-control" placeholder="Vui lòng nhập tên công ty" aria-describedby="helpId">
                        </div>
                        <div class="form-group">
                            <label for="uri">Link web (*)  <span class="text-danger" id ="uri_error"></span></label>
                        ...
                        <div class="form-group">
                            <label for="address">Địa chỉ (*) <span class="text-danger" id ="address_error"></span></label>
                            <textarea class="form-control"  name="address" rows="2"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="phone">Điện thoại (*) <span class="text-danger" id ="phone_error"></span></label>
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label for="password">Mật khẩu (*)  <span class="text-danger" id ="password_error"></span></label>
                            <input type="password" name="password"  class="form-control" placeholder="Vui lòng nhập password" aria-describedby="helpId">
                        </div>
                        <div class="form-group">
                            <label for="repass">Nhập lại mật khẩu (*)  <span class="text-danger" id ="repass_error"></span></label>
